...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_PretrainedModel.setGeometry(QtCore.QRect(40, 10, 120, 30))
        ...
        self.label_Data.setGeometry(QtCore.QRect(40, 70, 120, 30))
        self.label_Data.setStyleSheet("font: 12pt \"宋体\";")
        self.label_Data.setObjectName("label_Data")
        self.label_BestModel = QtWidgets.QLabel(self.centralwidget)
        self.label_BestModel.setGeometry(QtCore.QRect(40, 130, 120, 30))
        ...
        self.pushButton_RunParse.setGeometry(QtCore.QRect(690, 200, 70, 30))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(10)
        ...
        self.pushButton_StopParse = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_StopParse.setGeometry(QtCore.QRect(870, 200, 70, 30))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(10)
        self.pushButton_StopParse.setFont(font)
        self.pushButton_StopParse.setStyleSheet("")
        self.pushButton_StopParse.setObjectName("pushButton_StopParse")
        self.pushButton_Pause = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_Pause.setGeometry(QtCore.QRect(780, 200, 70, 30))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(10)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_PretrainedModel.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:10pt;\">路径中不要出现中文！</span></p></body></html>"))
        ...
        self.label_Data.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:10pt;\">若所选语料经过了预处理但本次训练更改了参数，请手动删除预处理后的文件：id2label.json，data.pkl</span></p></body></html>"))
        ...
        self.label_TaskName.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:10pt;\">如果要训练流水线式关系抽取模型，请先用相同语料、相同模型保存根路径、相同任务名称加&quot;_ner&quot;后缀训练一个实体识别模型，等训练完毕后再训练关系模型（无需改动语料路径和模型保存根路径）。</span></p></body></html>"))
        ...
        self.pushButton_StopParse.setText(_translate("MainWindow", "停止"))
